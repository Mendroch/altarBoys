  ...
  return (function n(e, r, t) {
  ...
  })(
    {
            ...
            return {
              ...
              parseV8OrIE: function (n) {
                ...
                return t.map(function (n) {
                  ...
                  var r = n
                    ...
                    o = r.join(' ') || void 0,
                    i = ['eval', '<anonymous>'].indexOf(t[0]) > -1 ? void 0 : t[0];
                  return new e({
                    functionName: o,
                    fileName: i,
                    lineNumber: t[1],
              ...
              parseFFOrSafari: function (n) {
                ...
                return r.map(function (n) {
                  if (
                    (n.indexOf(' > eval') > -1 &&
                      (n = n.replace(/ line (\d+)(?: > eval line \d+)* > eval\:\d+\:\d+/g, ':$1')),
                    n.indexOf('@') === -1 && n.indexOf(':') === -1)
                  )
                    return new e({ functionName: n });
                  var r = n.split('@'),
                    t = this.extractLocation(r.pop()),
                    o = r.join('@') || void 0;
                  return new e({
              ...
              parseOpera9: function (n) {
                for (
                  ...
                  var s = r.exec(t[i]);
                  s && o.push(new e({ fileName: s[2], lineNumber: s[1], source: t[i] }));
                }
                return o;
              },
        ...
        function (e, n, r) {
          ...
          (r.encode = function (e) {
            var n,
              r = '',
              o = t(e);
            do (n = o & u), (o >>>= a), o > 0 && (n |= c), (r += i.encode(n));
            while (o > 0);
            return r;
          }),
            (r.decode = function (e, n, r) {
              ...
              do {
                ...
                if (((s = i.decode(e.charCodeAt(n++))), s === -1))
      ...
      5: [
        function (e, n, r) {
          ...
          (r.GREATEST_LOWER_BOUND = 1),
            ...
            (r.search = function (e, n, o, i) {
              if (0 === n.length) return -1;
              var a = t(-1, n.length, e, n, o, i || r.GREATEST_LOWER_BOUND);
              if (a < 0) return -1;
              for (; a - 1 >= 0 && 0 === o(n[a], n[a - 1], !0); ) --a;
              return a;
            });
        },
        {},
          ...
          function i(e, n, r, a) {
            if (r < a) {
              var s = o(r, a),
                u = r - 1;
              t(e, s, a);
              for (var c = e[a], l = r; l < a; l++) n(e[l], c) <= 0 && ((u += 1), t(e, u, l));
              t(e, u + 1, l);
              var f = u + 1;
              i(e, n, r, f - 1), i(e, n, f + 1, a);
            }
          }
        ...
        function (e, n, r) {
          ...
          (t.fromSourceMap = function (e) {
            ...
            (t.prototype.allGeneratedPositionsFor = function (e) {
              ...
              if (
                (null != this.sourceRoot && (r.source = s.relative(this.sourceRoot, r.source)),
              ...
              if (o >= 0) {
                ...
                if (void 0 === e.column)
                  for (var a = i.originalLine; i && i.originalLine === a; )
                    t.push({
                  ...
                  for (
                    var c = i.originalColumn;
                    i && i.originalLine === n && i.originalColumn == c;
            ...
            (o.fromSourceMap = function (e) {
              var n = Object.create(o.prototype),
                ...
                t = (n._sources = c.fromArray(e._sources.toArray(), !0));
            ...
            (o.prototype._parseMappings = function (e, n) {
              for (
                ...
                if (';' === e.charAt(_)) c++, _++, (p = 0);
                else if (',' === e.charAt(_)) _++;
                else {
                  for (
                    r = new i(), r.generatedLine = c, a = _;
                    a < v && !this._charIsMappingSeparator(e, a);
                    a++
                  );
                  if (((t = e.slice(_, a)), (o = y[t]))) _ += t.length;
                  else {
                    for (o = []; _ < a; ) l.decode(e, _, w), (u = w.value), (_ = w.rest), o.push(u);
                  ...
                  (r.generatedColumn = p + o[0]),
                    ...
                    o.length > 1 &&
                      ((r.source = m + o[1]),
                      (m += o[1]),
                      (r.originalLine = g + o[2]),
                      (g = r.originalLine),
                      (r.originalLine += 1),
                      (r.originalColumn = h + o[3]),
                      (h = r.originalColumn),
                      o.length > 4 && ((r.name = d + o[4]), (d += o[4]))),
                    C.push(r),
                    'number' == typeof r.originalLine && b.push(r);
                }
              f(C, s.compareByGeneratedPositionsDeflated),
                (this.__generatedMappings = C),
                f(b, s.compareByOriginalPositions),
            ...
            (o.prototype.originalPositionFor = function (e) {
              var n = {
                ...
                r = this._findMapping(
                  ...
                  s.getArg(e, 'bias', t.GREATEST_LOWER_BOUND)
                );
              if (r >= 0) {
                ...
                if (o.generatedLine === n.generatedLine) {
                  ...
                  null !== i &&
                    ...
                    null != this.sourceRoot && (i = s.join(this.sourceRoot, i)));
            ...
            (o.prototype.sourceContentFor = function (e, n) {
              ...
              if (
                (null != this.sourceRoot && (e = s.relative(this.sourceRoot, e)),
                this._sources.has(e))
              )
            ...
            (o.prototype.generatedPositionFor = function (e) {
              ...
              if (
                (null != this.sourceRoot && (n = s.relative(this.sourceRoot, n)),
                !this._sources.has(n))
              )
            ...
            (r.BasicSourceMapConsumer = o),
            (a.prototype = Object.create(t.prototype)),
            (a.prototype.constructor = t),
            ...
            (a.prototype.generatedPositionFor = function (e) {
              for (var n = 0; n < this._sections.length; n++) {
                ...
                if (r.consumer.sources.indexOf(s.getArg(e, 'source')) !== -1) {
            ...
            (a.prototype._parseMappings = function (e, n) {
              ...
              for (var r = 0; r < this._sections.length; r++)
                for (
                  var t = this._sections[r], o = t.consumer._generatedMappings, i = 0;
                  i < o.length;
                  i++
                ) {
                  var a = o[i],
                    u = t.consumer._sources.at(a.source);
                  null !== t.consumer.sourceRoot && (u = s.join(t.consumer.sourceRoot, u)),
                    this._sources.add(u),
                  ...
                  var l = {
                    ...
                    generatedColumn:
                      a.generatedColumn +
                      (t.generatedOffset.generatedLine === a.generatedLine
                        ? t.generatedOffset.generatedColumn - 1
                        : 0),
      ...
      8: [
        function (e, n, r) {
          ...
          function a(e) {
            ...
            for (
              var a, s = r.isAbsolute(n), u = n.split(/\/+/), c = 0, l = u.length - 1;
              l >= 0;
              l--
            )
              (a = u[l]),
            ...
            return (n = u.join('/')), '' === n && (n = s ? '/' : '.'), t ? ((t.path = n), i(t)) : n;
          }
          function s(e, n) {
            '' === e && (e = '.'), '' === n && (n = '.');
            var r = o(n),
              t = o(e);
            if ((t && (e = t.path || '/'), r && !r.scheme)) return t && (r.scheme = t.scheme), i(r);
            if (r || n.match(_)) return n;
            if (t && !t.host && !t.path) return (t.host = n), i(t);
            var s = '/' === n.charAt(0) ? n : a(e.replace(/\/+$/, '') + '/' + n);
            return t ? ((t.path = s), i(t)) : s;
          }
          function u(e, n) {
            '' === e && (e = '.'), (e = e.replace(/\/$/, ''));
          ...
          (r.toSetString = y ? c : l),
            (r.fromSetString = y ? c : f),
            (r.compareByOriginalPositions = g),
            (r.compareByGeneratedPositionsDeflated = h),
        ...
        function (n, r, t) {
          !(function (o, i) {
            ...
            'function' == typeof e && e.amd
              ...
              : 'object' == typeof t
              ? (r.exports = i(n('stackframe')))
              : (o.StackGenerator = i(o.StackFrame));
          })(this, function (e) {
            return {
              backtrace: function (n) {
                ...
                for (var o = arguments.callee; o && r.length < t; ) {
                  ...
                  /function(?:\s+([\w$]+))+\s*\(/.test(o.toString())
                    ? r.push(new e({ functionName: RegExp.$1 || void 0, args: i }))
                    : r.push(new e({ args: i }));
                  try {
                    o = o.caller;
                  } catch (s) {
          ...
          !(function (n, o) {
            ...
            function t(e) {
              if (e instanceof Object)
                for (var r = o.concat(i.concat(a.concat(s))), t = 0; t < r.length; t++)
                  e.hasOwnProperty(r[t]) && void 0 !== e[r[t]] && this['set' + n(r[t])](e[r[t]]);
            }
            ...
            for (var u = 0; u < o.length; u++)
              (t.prototype['get' + n(o[u])] = r(o[u])),
                (t.prototype['set' + n(o[u])] = (function (e) {
                  return function (n) {
                    this[e] = Boolean(n);
                  };
                })(o[u]));
            for (var c = 0; c < i.length; c++)
              (t.prototype['get' + n(i[c])] = r(i[c])),
                (t.prototype['set' + n(i[c])] = (function (n) {
                  return function (r) {
                    if (!e(r)) throw new TypeError(n + ' must be a Number');
                    this[n] = Number(r);
                  };
                })(i[c]));
            for (var l = 0; l < a.length; l++)
              (t.prototype['get' + n(a[l])] = r(a[l])),
                (t.prototype['set' + n(a[l])] = (function (e) {
                  return function (n) {
                    this[e] = String(n);
                  };
                })(a[l]));
      ...
      11: [
        function (n, r, t) {
          !(function (o, i) {
            ...
            'function' == typeof e && e.amd
              ...
              : 'object' == typeof t
              ? (r.exports = i(n('source-map/lib/source-map-consumer'), n('stackframe')))
                ...
                t.open('get', e),
                  ...
                  (t.onreadystatechange = function () {
                    4 === t.readyState &&
                      ...
                      ('file://' === e.substr(0, 7) && t.responseText)
                        ? n(t.responseText)
                        : r(new Error('HTTP status: ' + t.status + ' retrieving ' + e)));
                  }),
                  t.send();
              });
            }
            ...
            function u(e) {
              var n = /\/\/[#@] ?sourceMappingURL=([^\s'"]+)\s*$/m.exec(e);
              if (n && n[1]) return n[1];
              throw new Error('sourceMappingURL not found');
            }
            function c(e, r, t) {
              return new Promise(function (o, i) {
                var a = r.originalPositionFor({ line: e.lineNumber, column: e.columnNumber });
                if (a.source) {
                  var s = r.sourceContentFor(a.source);
                  s && (t[a.source] = s),
                    o(
                      new n({
            ...
            return function l(f) {
              return this instanceof l
                ? ((f = f || {}),
                  (this.sourceCache = f.sourceCache || {}),
                  (this.sourceMapConsumerCache = f.sourceMapConsumerCache || {}),
                  (this.ajax = f.ajax || r),
                  (this._atob = f.atob || t),
                  (this._get = function (e) {
                    return new Promise(
                      function (n, r) {
                        var t = 'data:' === e.substr(0, 5);
                        if (this.sourceCache[e]) n(this.sourceCache[e]);
                          ...
                          if (i) {
                            var a = i[0].length,
                              s = e.substr(a),
                              u = this._atob(s);
                            (this.sourceCache[e] = u), n(u);
                          } else
                            r(new Error('The encoding of the inline sourcemap is not supported'));
                        } else {
                          var c = this.ajax(e, { method: 'get' });
                          (this.sourceCache[e] = c), c.then(n, r);
                        }
                      }.bind(this)
                    );
                  }),
                  (this._getSourceMapConsumer = function (n, r) {
                    return new Promise(
                      function (t, i) {
                        if (this.sourceMapConsumerCache[n]) t(this.sourceMapConsumerCache[n]);
                        else {
                          var a = new Promise(
                            function (t, i) {
                              return this._get(n).then(function (n) {
                                'string' == typeof n && (n = o(n.replace(/^\)\]\}'/, ''))),
                                  'undefined' == typeof n.sourceRoot && (n.sourceRoot = r),
                                  t(new e.SourceMapConsumer(n));
                              }, i);
                            }.bind(this)
                          );
                          (this.sourceMapConsumerCache[n] = a), t(a);
                        }
                      }.bind(this)
                    );
                  }),
                        ...
                        this._get(o)
                          .then(
                            function (r) {
                              ...
                              return (
                                '/' === i[0] || a || /^https?:\/\/|^\/\//i.test(i) || (i = s + i),
                                this._getSourceMapConsumer(i, s).then(function (r) {
                                  return c(e, r, t)
                                    .then(n)
                                    ['catch'](function () {
                                      n(e);
        ...
        { 'source-map/lib/source-map-consumer': 7, stackframe: 10 },
      ],
      12: [
        function (n, r, t) {
          !(function (o, i) {
            ...
            'function' == typeof e && e.amd
              ...
              : 'object' == typeof t
              ? (r.exports = i(n('error-stack-parser'), n('stack-generator'), n('stacktrace-gps')))
            ...
            var a = {
                filter: function (e) {
                  return (
                    (e.functionName || '').indexOf('StackTrace$$') === -1 &&
                    (e.functionName || '').indexOf('ErrorStackParser$$') === -1 &&
                    (e.functionName || '').indexOf('StackTraceGPS$$') === -1 &&
                    (e.functionName || '').indexOf('StackGenerator$$') === -1
                  );
                },
                sourceCache: {},
              },
            ...
            return {
              ...
              generateArtificially: function (e) {
                ...
                var r = n.backtrace(e);
                return (
                  'function' == typeof e.filter && (r = r.filter(e.filter)), Promise.resolve(r)
                );
              },
                    ...
                    (a.onreadystatechange = function () {
                      4 === a.readyState &&
                        (a.status >= 200 && a.status < 400
                          ? o(a.responseText)
                          : i(new Error('POST to ' + n + ' failed with status: ' + a.status)));
                    }),
                    a.open('post', n),
                    a.setRequestHeader('Content-Type', 'application/json'),
                    t && 'object' == typeof t.headers)
                  ) {
                    var s = t.headers;
                    for (var u in s) s.hasOwnProperty(u) && a.setRequestHeader(u, s[u]);
                  }
                  var c = { stack: e };
                  void 0 !== r && null !== r && (c.message = r), a.send(JSON.stringify(c));
                });
              },
            };
          });
        },
        { 'error-stack-parser': 1, 'stack-generator': 9, 'stacktrace-gps': 11 },
      ],
    },
    {},
    [12]
